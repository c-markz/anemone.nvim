...
local theme = lush(function(injected_functions)
	...
	return {
		...
		StatusLine({ fg = hsl("#e6e6e6"), bg = hsl("#606161"), gui = "bold" }), -- Status line of current window
		StatusLineNC({ fg = hsl("#e6e6e6"), bg = hsl("#606161") }), -- Status lines of not-current windows. Note: If this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
		-- TabLine        { }, -- Tab pages line, not active tab page label
		-- TabLineFill    { }, -- Tab pages line, where there are no labels
		-- TabLineSel     { }, -- Tab pages line, active tab page label
		Title({ fg = hsl("#ff75b5"), bg = hsl("#615956"), gui = "bold" }), -- Titles for output from ":set all", ":autocmd" etc.
		Visual({ bg = hsl("#3e3937") }), -- Visual mode selection
		...
		Boolean({ ctermfg = 215, fg = hsl("#ffb86c") }), --   A boolean constant: TRUE, false
		Float({ fg = hsl("#ffb86c") }), --   A floating point constant: 2.3e10

		Identifier({ fg = hsl("#ffb86c") }), -- (*) Any variable name
		Function({ fg = hsl("#65bdff") }), --   Function name (also: methods for classes)

		Statement({ fg = hsl("#ff75b5") }), -- (*) Any statement
		Conditional({ fg = "#ff75b5" }), --   if, then, else, endif, switch, etc.
		-- Repeat         { }, --   for, do, while, etc.
		Label({ fg = hsl("#19f9d8") }), --   case, default, etc.
		Operator({ fg = hsl("#ff75b5") }), --   "sizeof", "+", "*", etc.
		Keyword({ fg = hsl("#ff75b5") }), --   any other keyword
		-- Exception      { }, --   try, catch, throw

		PreProc({ fg = hsl("#ff75b5") }), -- (*) Generic Preprocessor
		-- Include        { }, --   Preprocessor #include
		Define({ fg = hsl("#ff75b5") }), --   Preprocessor #define
		...
		Tag({ fg = hsl("#ff2c6d") }), --   You can use CTRL-] on this
		...
		Todo({ fg = hsl("#676b79"), gui = "inverse, bold, italic" }), -- Anything that needs extra attention; mostly the keywords TODO FIXME and XXX
